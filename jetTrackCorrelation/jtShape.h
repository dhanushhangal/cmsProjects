...
class jtShape {
	public:
		...
		jtShape();
		TH2D* getSignal(TH2D* signalH2, TH2D* meH2, TH1D* jetDist, float sideMin, float sideMax);
...
TH2D* jtShape::getSignal(TH2D* signalH2, TH2D* meH2, TH1D* jetDist, float sideMin = 1.5, float sideMax = 2){
