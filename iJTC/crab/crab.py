...
config.General.requestName = 'cymbal_trkClosure_fineBin_noDCAcuts_make'
...
config.JobType.inputFiles = ['FrameworkJobReport.xml',subScript,'lib.tar.gz', 'corrTable.tar.gz']
